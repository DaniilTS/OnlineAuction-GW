...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='FirstName')
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='SecondName')
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='ThirdName')
CREATE TABLE [ThirdName]
(
	[Id] UNIQUEIDENTIFIER PRIMARY KEY NOT NULL,
	[Value] NVARCHAR(50) UNIQUE NOT NULL
)
...
(
	[Id] UNIQUEIDENTIFIER PRIMARY KEY NOT NULL,
	[FirstNameId] UNIQUEIDENTIFIER REFERENCES [FirstName] (Id) NOT NULL,
	[SecondNameId] UNIQUEIDENTIFIER REFERENCES [SecondName] (Id) NOT NULL,
	[ThirdNameId] UNIQUEIDENTIFIER REFERENCES [ThirdName] (Id) DEFAULT NULL
)
GO
...
(
	...
	[GenderId] UNIQUEIDENTIFIER REFERENCES [Gender] (Id) NOT NULL,
	[FullNameId] UNIQUEIDENTIFIER REFERENCES [FullName] (Id) NOT NULL,
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='IdentityType')
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='Identity')
CREATE TABLE [Identity]
(
	[Id] UNIQUEIDENTIFIER PRIMARY KEY NOT NULL,
	[IdentityTypeId] UNIQUEIDENTIFIER REFERENCES [IdentityType] (Id),
	[Value] NVARCHAR(30) UNIQUE NOT NULL,
	[UserId] UNIQUEIDENTIFIER REFERENCES [User] (Id) NOT NULL
)
GO
